...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? AppPetAddingWidget() : Auth1Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'appPetAdding',
          path: '/appPetAdding',
          builder: (context, params) => AppPetAddingWidget(),
        ),
        FFRoute(
          name: 'Auth1',
          path: '/auth1',
        ...
        FFRoute(
          name: 'Mascota',
          path: '/mascota',
          builder: (context, params) => MascotaWidget(
        ...
        FFRoute(
          name: 'muro',
          path: '/muro',
          builder: (context, params) => MuroWidget(),
        ),
        FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/iconPrincipal.jpeg',
                    fit: BoxFit.none,
                  ),
                )
              : page;
