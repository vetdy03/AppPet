...
class UserRecord extends FirestoreRecord {
  ...
  // "confirmar_contra" field.
  String? _confirmarContra;
  String get confirmarContra => _confirmarContra ?? '';
  bool hasConfirmarContra() => _confirmarContra != null;
  ...
  void _initializeFields() {
    ...
    _confirmarContra = snapshotData['confirmar_contra'] as String?;
...
class UserRecordDocumentEquality implements Equality<UserRecord> {
  ...
  bool equals(UserRecord? e1, UserRecord? e2) {
    return e1?.nombre == e2?.nombre &&
        ...
        e1?.confirmarContra == e2?.confirmarContra &&
        e1?.correo == e2?.correo &&
        e1?.email == e2?.email &&
