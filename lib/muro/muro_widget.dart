...
import 'muro_model.dart';
export 'muro_model.dart';

class MuroWidget extends StatefulWidget {
  const MuroWidget({super.key});

  @override
  State<MuroWidget> createState() => _MuroWidgetState();
}

class _MuroWidgetState extends State<MuroWidget> {
  late MuroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MuroModel());
  }
