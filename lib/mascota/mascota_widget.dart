...
class MascotaWidget extends StatefulWidget {
  ...
  @override
  State<MascotaWidget> createState() => _MascotaWidgetState();
}

class _MascotaWidgetState extends State<MascotaWidget> {
  late MascotaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MascotaModel());
          ...
          children: [
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment: AlignmentDirectional(1.23, 0.9),
                                    child: FlutterFlowIconButton(
                                      borderRadius: 112.0,
                                      buttonSize: 35.0,
                                      fillColor:
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                validator:
                    _model.razaTextControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
              child: TextFormField(
                ...
                validator:
                    _model.colorTextControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Otros datos importantes',
                  hintStyle: FlutterFlowTheme.of(context).labelMedium.override(
                        fontFamily: 'Inter',
                        letterSpacing: 0.0,
                      ),
